...
class SaveBulkContactPage extends StatelessWidget {
  ...
  Future<void> _handleSubmitted()async
  {
    ...
    for (Map<String, dynamic> jsonItem in json)
    {
        try{
          ...
          contact.givenName = "Student "+jsonItem[keys[1]];
          contact.middleName = "";
          contact.familyName = "";
          contact.prefix = "";
          contact.suffix = "";
          contact.phones = [Item(label: "mobile", value: jsonItem[keys[2]].toString())];
          contact.emails = null;
          contact.company = "";
          contact.company = "";
          contact.jobTitle = "";
